		...
		if not InBlacklistedVehicle then
			...
			if nearPump and IsCloseToLastVehicle then
				...
				if IsPedInAnyVehicle(GetPlayerPed(-1), false) then
					DrawText3Ds(pumpLoc['x'], pumpLoc['y'], pumpLoc['z'], "Sal del vehiculo para llenar el tanque de gasolina del vehiculo.")
				elseif IsFueling then
					local position = GetEntityCoords(vehicle)

					DrawText3Ds(pumpLoc['x'], pumpLoc['y'], pumpLoc['z'], "Pulsa ~g~G ~w~para dejar de llenar el tanque de gasolina del vehiculo. $~r~" .. price .. " ~w~+  €")
				...
				elseif fuel > 95.0 then
					DrawText3Ds(pumpLoc['x'], pumpLoc['y'], pumpLoc['z'], "El tanque de gasolina del vehiculo esta lleno.")
				elseif cash <= 0 then
					DrawText3Ds(pumpLoc['x'], pumpLoc['y'], pumpLoc['z'], "No llevas suficiente dinero para llenar el tanque de gasolina.")
				else
					DrawText3Ds(pumpLoc['x'], pumpLoc['y'], pumpLoc['z'], "Pulsa ~g~G ~w~para llenar el tanque de gasolina. $~r~0.5/~w~litro + €")
			...
			elseif NearVehicleWithJerryCan and not nearPump and Config.EnableJerryCans then
				...
				if IsFuelingWithJerryCan then
					DrawText3Ds(coords.x, coords.y, coords.z + 0.5, "Pulsa ~g~G ~w~para dejar de llenar el tanque de gasolina del vehiculo. Llevas: " .. fuel .. "% - Jerry Can: " .. jerrycan)
					...
					DrawText3Ds(coords.x, coords.y, coords.z + 0.5, "Pulsa ~g~G ~w~para llenar el tanque de gasolina con tu bidon.")
