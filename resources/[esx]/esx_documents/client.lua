...
function OpenMainMenu()
    ClearMenu()
    Menu.addButton("Documentos Publicos", "OpenNewPublicFormMenu", nil)
    Menu.addButton("Documentos del trabajo", "OpenNewJobFormMenu", nil)
    Menu.addButton("Mis documentos", "OpenMyDocumentsMenu", nil)
...
function ShowToNearestPlayers(aDocument)
    ...
    if #players_clean > 0 then
        ...
        Menu.addButton("No hay jugadores cerca", "CloseMenu", nil)
    end
...
function CopyToNearestPlayers(aDocument)
    ...
    Menu.addButton("Volver", "OpenFormPropertiesMenu", aDocument)
    Menu.addButton("Cerrar", "CloseMenu", nil)
end
...
function OpenFormPropertiesMenu(aDocument)
    ClearMenu()
    Menu.addButton("Ver documento", "ViewDocument", aDocument.data)
    Menu.addButton("Enseñar", "ShowToNearestPlayers", aDocument.data)
    Menu.addButton("Dar copia", "CopyToNearestPlayers", aDocument.data)
    Menu.addButton("Borrar", "OpenDeleteFormMenu", aDocument)
    Menu.addButton("Volver", "OpenMyDocumentsMenu", nil)
    Menu.addButton("Cerrar", "CloseMenu", nil)
    Menu.hidden = false
end
...
function OpenDeleteFormMenu(aDocument)
    ClearMenu()
    Menu.addButton("Si, borrar", "DeleteDocument", aDocument)
    Menu.addButton("Volver", "OpenFormPropertiesMenu", aDocument)
    Menu.addButton("Cerrar", "CloseMenu", nil)
    Menu.hidden = false
end
