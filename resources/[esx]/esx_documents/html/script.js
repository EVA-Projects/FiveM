...
function Form (_title, _subtitle, _elements, _submittable)
{
	...
	this.print = function () { 
		...
		html_footer += "</div>";
		html_footer += "<div id=\"signature_block\">Click para firmar.</div>";

		/*  Cancel & Submit button */

		if (this.submittable) {
			html_footer += "<button id=\"button_cancel\" type=\"button\">Cancelar</button>";
			html_footer += "<button id=\"button_submit\" type=\"button\">Enviar</button>";
		}
