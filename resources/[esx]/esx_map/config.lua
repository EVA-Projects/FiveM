...
Config.Map = {
  ...
  --{name="Yate",color=15, id=410, x=-2045.800, y=-1031.200, z=11.900},
  {name="Bahamas",color=27, id=93,x =-1388.409, y =-585.624, z =100.319},
  --{name="Puticlub",color=27, id=121,x =132.17, y =-1304.42, z =100.319},
  ...
  {name="Tienda",color=2, id=52,x =1961.464, y =3740.672, z =31.343},
