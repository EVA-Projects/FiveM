...
local bankMenu = true
local banks = {
  {title="Banco", id=108, x=150.266, y=-1040.203, z=29.374},
  ...
  {name="Banco", id=277, x=-38.31, y=-1115.72, z=26.44},
}	

local atms = {
  {title="ATM", id=277, x=-386.733, y=6045.953, z=31.501},
  ...
  {name="ATM", id=277, x=219.69, y=-812.66, z=30.61},
  {name="ATM", id=277, x=217.13, y=-811.6, z=30.68},
...
if bankMenu then
  ...
  while true do
	...
	if nearBank() or nearATM() then
			DisplayHelpText("Presiona ~INPUT_PICKUP~ para acceder al cajero ~b~")
