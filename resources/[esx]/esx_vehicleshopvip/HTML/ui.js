...
function CloseShop() {
    $("#wrapper").html('');
	$("#shopmenu").hide();
    $.post('http://esx_vehicleshopvip/CloseMenu', JSON.stringify({}));
}
...
$(document).ready(function(){
    ...
    $(".card-body").on('click', ':button', function () {
        $("#shopmenu").hide();
        $("#wrapper").html('');
        $.post('http://esx_vehicleshopvip/BuyVehicle', JSON.stringify({id: $(this).data('id')}));
    });
                                        ...
                                        <div class="col">
                                            <div class="card" style="border:0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Precio: <b>€`+data.cars[st].price+`</b></p>
                                        ...
                                        <div class="col">
                                            <div class="card" style="border:0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Precio: <b>€`+data.cars[nd].price+`</b></p>
                                        ...
                                        <div class="col">
                                            <div class="card" style="border:0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Precio: <b>€`+data.cars[rd].price+`</b></p>
                                        ...
                                        <div class="col">
                                            <div class="card" style="border:0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Precio: <b>€`+data.cars[th].price+`</b></p>
                                        ...
                                        <div class="col">
                                            <div class="card" style="border:0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Precio: <b>€`+data.cars[kh].price+`</b></p>
                                        ...
                                        <div class="col">
                                            <div class="card" style="border:0">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <p class="card-text">Precio: <b>€`+data.cars[lh].price+`</b></p>
