...
Config.Animations = {
...

	{
		...
		label = 'Laboral',
		items = {
			{label = "Sospechoso: se rinde a la policia.", type = "anim", data = {lib = "random@arrests@busted", anim = "idle_c"}},
			...
			{label = "Agricultor: cosecha", type = "scenario", data = {anim = "world_human_gardener_plant"}},
			{label = "Mecánico: reparar el motor.", type = "anim", data = {lib = "mini@repair", anim = "fixing_a_ped"}},
			...
			{label = "Taxi: dar la cuenta", type = "anim", data = {lib = "oddjobs@taxi@cyi", anim = "std_hand_off_ps_passenger"}},
...

	{
		...
		items = {
			...
			{label = "Venir", type = "anim", data = {lib = "gestures@m@standing@casual", anim = "gesture_come_here_soft"}}, 
			...
			{label = "Lo he follado", type = "anim", data = {lib = "anim@am_hold_up@male", anim = "shoplift_high"}},
...

	{
		...
		items = {
			...
			{label = "Hacer bombas", type = "anim", data = {lib = "amb@world_human_push_ups@male@base", anim = "base"}},
...

	{
		...
		items = {
			...
			{label = "Demasiado comer", type = "attitude", data = {lib = "move_m@fat@a", anim = "move_m@fat@a"}},
			...
			{label = "Músculoso", type = "attitude", data = {lib = "move_m@muscle@a", anim = "move_m@muscle@a"}},
			...
			{label = "Hombre devorador", type = "attitude", data = {lib = "move_f@maneater", anim = "move_f@maneater"}},
	...
	{
		name  = 'porn',
		label = 'Animaciones +18',
		items = {
			{label = "Hombre que se hace fo**** en coche", type = "anim", data = {lib = "oddjobs@towing", anim = "m_blow_job_loop"}},
			{label = "Mujer haciendo una pa** en coche", type = "anim", data = {lib = "oddjobs@towing", anim = "f_blow_job_loop"}},
			{label = "Hombre besándose ** en coche", type = "anim", data = {lib = "mini@prostitutes@sexlow_veh", anim = "low_car_sex_loop_player"}},
			{label = "Mujer fo***** en coche", type = "anim", data = {lib = "mini@prostitutes@sexlow_veh", anim = "low_car_sex_loop_female"}},
