...
{    
    ...
    */
    loadingMessages:
    [
        "Bienvenido a OakumLife RP",
        "Te estamos conectando...",
        "Estamos cargando tus datos...",
        "Estamos conectandote, espera...",
        "Recuarda pasarte por nuestro discord.",
        "Recuerda leer las normas...",
        "Usa [º] para levantar las manos",
        "Recuerda usar /ME y /DO para rolear",
        "Usa [F1] para abrir el movil",
        "Te estamos conectando...",
        "Recuerda leer las normas de el servidor.",
        "Recuerda pasarte por el foro...",
        "Las normas son muy importantes"
    ],
