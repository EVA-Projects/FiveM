...
var render = function () {
 ...
 // ctx.fillText(game_state.win, 265, 358);
  ctx.fillText("Ganado " + game_state.paid+"€", 385, 367);

  ctx.fillText("Apuesta " +playerbet+"€", 595, 367);
  ...
  // draw game state highlight tiles
	...
	ctx.textAlign = "right";
	ctx.textBaseline = "top";
	  ctx.fillText("Tirada gratis " +freespins, 395, 367);
  ctx.fillText("Apuesta " + game_state.paid+"€", 625, 367);
  }
