...
AddEventHandler('sawu_hookers:pay', function(boolean)
    ...
    if (boolean == true) then
        if xPlayer.getMoney() >= Config.BlowjobPrice then
            ...
            TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = 'Has pagado: ' .. Config.BlowjobPrice ..' €' })
            ...
            TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'error', text = 'No tienes suficiente dinero' })
        ...
        if xPlayer.getMoney() >= Config.SexPrice then
            ...
            TriggerClientEvent('mythic_notify:client:SendAlert', _source, { type = 'inform', text = 'Has pagado: ' .. Config.SexPrice ..' €' })
            -- this adds money to society_nightclub
            if Config.SocietyNightclub then
                TriggerEvent('esx_addonaccount:getSharedAccount', 'society_nightclub', function(account)
