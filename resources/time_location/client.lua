        ...
        if(GetStreetNameFromHashKey(var1) and GetNameOfZone(pos.x, pos.y, pos.z))then
            if lang == 'en' then
                if(zones_en[GetNameOfZone(pos.x, pos.y, pos.z)] and tostring(GetStreetNameFromHashKey(var1)))then
                    drawTxt2(0.015, 0.745, 1.0,1.0,0.4, zones_en[GetNameOfZone(pos.x, pos.y, pos.z)], 255, 255, 255, 255)
                end
            elseif lang == 'ru' then
...
Citizen.CreateThread(function()
	while true do
		...
		if displayTime == true then
			...
			timeAndDateString = timeAndDateString .. "Hora: " .. hour .. ":" .. minute  -- Example: Time: 00:00
		end
